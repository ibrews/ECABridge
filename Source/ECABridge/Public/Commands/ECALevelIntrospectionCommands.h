...
public:
	...
	{
		return {
			{ TEXT("verbosity"), TEXT("string"), TEXT("Response depth: 'summary' (default, name+class+tags only), 'transforms' (+transform/mobility), 'full' (+components and optional properties). Old include_components/include_properties args are honored for backwards-compat with a deprecation hint."), false, TEXT("summary") },
			...
			{ TEXT("include_properties"), TEXT("boolean"), TEXT("[deprecated] Use verbosity=full. Include full property dump per actor."), false, TEXT("false") },
			{ TEXT("include_components"), TEXT("boolean"), TEXT("[deprecated] Use verbosity=full. Include component list per actor."), false, TEXT("false") },
